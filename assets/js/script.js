...
const setVideoSource = () => {
  ...
  if (windowWidth <= 600) {
    videoElement.src = `${url_audios_deploy}/assets/images/haunted-mansion-mobile.webm`;
  } else if (windowWidth <= 1024) {
    videoElement.src = `${url_audios_deploy}/assets/images/haunted-mansion-tablet.webm`;
  } else {
